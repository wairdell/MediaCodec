...
extern "C" JNIEXPORT jlong JNICALL Java_com_android_rtmpvideo_RtmpJni_initRtmp(JNIEnv* env,jclass jcls,jstring jurl,jstring jlogpath)
{
...
extern "C" JNIEXPORT jint JNICALL Java_com_android_rtmpvideo_RtmpJni_sendSpsAndPps(JNIEnv* env,jclass jcls,jlong cptr,jbyteArray jsps, jint spsLen, jbyteArray jpps, jint ppsLen)
{
...
extern "C" JNIEXPORT jint JNICALL Java_com_android_rtmpvideo_RtmpJni_sendVideoFrame(JNIEnv* env,jclass jcls,jlong cptr,jbyteArray jframe, jint len,jint time)
{
...
extern "C" JNIEXPORT jint JNICALL Java_com_android_rtmpvideo_RtmpJni_sendAacSpec(JNIEnv* env, jclass jcls,jlong cptr, jbyteArray jaacSpec, jint jlen)
{
...
extern "C" JNIEXPORT jint JNICALL Java_com_android_rtmpvideo_RtmpJni_sendAacData(JNIEnv* env, jclass jcls, jlong cptr,jbyteArray jaccFrame, jint jlen, jint jtimestamp)
{
...
extern "C" JNIEXPORT jint JNICALL Java_com_android_rtmpvideo_RtmpJni_stopRtmp(JNIEnv* env,jclass jcls,jlong cptr)
{
