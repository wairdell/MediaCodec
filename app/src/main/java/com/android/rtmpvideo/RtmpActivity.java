...
public class RtmpActivity extends AppCompatActivity implements View.OnClickListener, VideoGather.CameraOperateCallback, MediaPublisher.ConnectRtmpServerCb, SurfacePreview.PermissionNotify {
...
//    private static final String rtmpUrl = "rtmp://sendtc3a.douyu.com/live/11209824rV3GCeH2?wsSecret=0802c14330781ac6c76cbc04c28b2385&wsTime=636487fe&wsSeek=off&wm=0&tw=0&roirecognition=0&record=flv&origin=tct&txHost=sendtc3a.douyu.com";
    public static final String rtmpUrl = "rtmp://10.10.30.136/live/livestream";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String logPath = getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS)
                + "/" + "rtmp.log";
        ...
        Log.e("TAG", "logPath => " + logPath + " , " + file.canWrite());
        file = null;
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (ret == 0) {
                    ...
                    //更新UI
                    Toast.makeText(RtmpActivity.this, "RTMP流媒体服务器连接失败,请检测网络或服务器是否启动!", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
